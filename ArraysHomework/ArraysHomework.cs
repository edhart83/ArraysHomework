...
namespace ArraysHomework
{
    ...
    public class ArraysHomework
    {
        ...
        public void Arrays()
        {
            ...
            string temp1 = swapMyValues[0];
            string temp2 = swapMyValues[2];
            swapMyValues[0] = temp2;
            swapMyValues[2] = temp1;
        ...
        public void Lists()
        {
            ...
            foreach (char letter in copyMe)
            {
                copiedList.Add(letter);
            }
            ...
            int[] sortMeArr = new int[5];
            int i = 0;
            while (i < sortMe.Count)
            {
                sortMeArr[i] = sortMe[i];
                i++;
            }


            // BONUS Check if sortMe Contains the value 2.
            foreach (int index in sortMe)
            {
                if(index == 2)
                {
